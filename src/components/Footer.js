...
const PAYMENTS = ["Visa", "Mastercard", "PayPal", "Momo", "ZaloPay"];
...
const SOCIAL_ICONS = [
  ...
  { label: "Instagram", path: "M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm5 5a5 5 0 100 10 5 5 0 000-10zm6-1.5a1 1 0 100 2 1 1 0 000-2z" },
  { label: "YouTube", path: "M22 12s0-3.2-.4-4.6a2.5 2.5 0 00-1.8-1.8C18.4 5.2 12 5.2 12 5.2s-6.4 0-7.8.4A2.5 2.5 0 002.4 7.4C2 8.8 2 12 2 12s0 3.2.4 4.6a2.5 2.5 0 001.8 1.8c1.4.4 7.8.4 7.8.4s6.4 0 7.8-.4a2.5 2.5 0 001.8-1.8C22 15.2 22 12 22 12zM10 15.5v-7l6 3.5-6 3.5z" },
  { label: "Pinterest", path: "M12 2a10 10 0 00-3.6 19.3c0-.8-.1-2 0-2.8l1.4-6s-.4-.7-.4-1.8c0-1.7 1-3 2.2-3 1 0 1.5.8 1.5 1.7 0 1-.7 2.5-1 4-.3 1.1.6 2 1.7 2 2 0 3.5-2.1 3.5-5.2 0-2.7-2-4.6-4.8-4.6-3.3 0-5.2 2.4-5.2 4.9 0 1 .4 2 .8 2.6.1.1.1.2.1.3l-.3 1.3c0 .2-.2.3-.4.2-1.4-.6-2.2-2.5-2.2-4.1 0-3.3 2.4-6.4 7-6.4 3.7 0 6.5 2.6 6.5 6.1 0 3.7-2.3 6.6-5.5 6.6-1.1 0-2.1-.6-2.4-1.2l-.7 2.5c-.2 1-.9 2.2-1.3 2.9A10 10 0 1012 2z" },
];
...
export default function Footer() {
  ...
  return (
    <footer className="bg-neutral-950 px-4 pt-6 text-white md:px-8">
      ...
      <div className="mx-auto grid max-w-[1336px] grid-cols-2 gap-6 border-b border-white/10 py-8 md:grid-cols-5 md:gap-8 md:py-10">
        ...
        <FooterCol
          title={t.footer.shop}
          links={[
            { label: t.newArrivals, href: "/products?tab=new" },
            { label: t.preOrders, href: "/products?tab=preorder" },
            { label: t.nav.sale, href: "/sale" },
            { label: t.scale118, href: "/products?tab=1-18" },
            { label: t.scale124, href: "/products?tab=1-24" },
          ]}
        />
        <FooterCol
          className="hidden md:block"
          title={t.footer.brands}
          links={["Porsche", "Mercedes-Benz", "BMW", "Ferrari", "Lamborghini"].map((label) => ({
            label,
        ...
        <FooterCol
          className="hidden md:block"
          title={t.footer.manufacturers}
          links={[
            { label: "Norev", slug: "norev" },
            { label: "Minichamps", slug: "minichamps" },
            { label: "GT Spirit", slug: "gt-spirit" },
            { label: "IXO", slug: "ixo" },
            { label: "MCG", slug: "mcg" },
          ].map((b) => ({ label: b.label, href: `/products?brand=${b.slug}` }))}
        />
        <FooterCol
          title={t.footer.help}
          links={[
            { label: "FAQ", href: "/#faq" },
            { label: t.faq.contact, href: "/contact" },
